...
//            }
    ...
    private void scheduleJob() {
        // [START dispatch_job]
        OneTimeWorkRequest work = new OneTimeWorkRequest.Builder(FirebaseMessagingWorker.class)
                .build();
     ...
     * @param
     */
    private void sendNotification(String status, String bookingId, String title, String body) {
        Intent intent = new Intent(this, MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra(AppConstants.key_status, status);
